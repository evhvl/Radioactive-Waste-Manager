...
class Tabs:
    ...
    def _tab_disposal(self, tab):
        ...
        Button(frame, text="Tc99m", **GEN_BUTTON_STYLE, command=lambda: self.create_new_tab("Tc99m Disp")).grid(row=1, column=0, sticky="w", padx=20, pady=5)
        Button(frame, text="Ga68", **GEN_BUTTON_STYLE, command=lambda: self.create_new_tab("Ga68 Disp")).grid(row=1, column=1, sticky="e", padx=20, pady=5)
        Button(frame, text="Lu177", **GEN_BUTTON_STYLE, command=lambda: self.create_new_tab("Lu177 Disp")).grid(row=0, column=1, sticky="w", padx=20, pady=5)
